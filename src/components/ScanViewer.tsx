...
export default function ScanViewer({ model }: { model: ViewerModel }) {
  ...
  return (
    <main className="viewer-page">
      ...
      <div className="viewer-status"><i /> {model.source.kind === "demo" ? "DEMO SCAN · SOG NOT CONNECTED" : "3DGS ASSET CONFIGURED · LOADER NOT CONNECTED"}</div>
