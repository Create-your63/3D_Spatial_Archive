...
import { records, type RecordStatus, type SpatialRecord } from "./data";
      ...
      <section className="map-stage" aria-label="공간 기록 지도">
        ...
        <article className="map-record-card">
          ...
          <div className="card-actions">
            <Link href={`/records/${selected.id}`}>기록 자세히 보기 <ArrowRight size={16} /></Link>
            <Link className="view-3d-button" href={`/viewer/${selected.id}`}><Box size={17} /> 3D로 보기</Link>
          </div>
        </article>
